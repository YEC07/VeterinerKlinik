...
namespace VeterinerKlinik.Controllers
{
    public class InventoryController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ItemId,Name,Type,StockQuantity,UnitPrice,ExpiryDate")] Inventory inventory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ItemId,Name,Type,StockQuantity,UnitPrice,ExpiryDate")] Inventory inventory)
        {
